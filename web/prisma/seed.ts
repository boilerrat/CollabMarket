...
async function main() {
  // Idempotent seed: upsert a couple of users, profiles, projects, roles
  ...
  await prisma.collaboratorProfile.upsert({
    ...
    create: {
      ...
      links: [{ label: "GitHub", url: "https://github.com/alice" } as any],
    },
  });
  ...
  await prisma.collaboratorProfile.upsert({
    ...
    create: {
      ...
      links: [{ label: "Website", url: "https://bob.example" } as any],
    },
  });
  ...
  const project = await prisma.project.upsert({
    ...
    create: {
      ...
      projectType: "miniapp",
      skills: ["react", "nextjs"],
      ownerSnapshot: { handle: alice.handle, displayName: alice.displayName, avatarUrl: alice.avatarUrl } as any,
    },
  });
